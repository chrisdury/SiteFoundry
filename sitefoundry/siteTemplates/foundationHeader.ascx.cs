namespace Dury.SiteFoundry.siteTemplates
{
	...
	/// <summary>
	///		Summary description for foundationHeader.
	/// </summary>
	public class foundationHeader : Dury.SiteFoundry.UI.BaseControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			menu.Text = root.Find(new ArrayList(new string[] {"foundation"})).ToHTML(0);
