namespace Dury.SiteFoundry.nodeTemplates.formBuilder
{
	...
	/// <summary>
	///		Summary description for displayFieldTextMultiline.
	/// </summary>
	public class displayFieldTextMultiline : Dury.SiteFoundry.FieldControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (FormField.Rows > 0) answer.Rows = FormField.Rows;
			if (Mode == "Display") 
			{
