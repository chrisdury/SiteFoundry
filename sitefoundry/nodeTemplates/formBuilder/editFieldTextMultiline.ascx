<%@ Control Language="c#" AutoEventWireup="false" Codebehind="editFieldTextMultiline.ascx.cs" Inherits="Dury.SiteFoundry.nodeTemplates.formBuilder.editFieldTextMultiline" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<h4>text multiline</h4>
<table border="0" cellpadding="2" cellspacing="0">
	...
	<tr><td>rows:</td><td><asp:textbox id="rows" runat="server" width="20" maxlength="2"/></td></tr>
