namespace Dury.SiteFoundry.nodeTemplates.formBuilder
{
	...
	/// <summary>
	///		Summary description for editFieldTextMultiline.
	/// </summary>
	public class editFieldTextMultiline : Dury.SiteFoundry.FieldControl
	{
		...
		private void load() 
		{
			...
			if (FormField.Rows > 0) rows.Text = FormField.Rows.ToString();
		...
		private void saveButton_Click(object sender, EventArgs e)
		{
			...
			if (action == "edit") 
			{
				...
				ff.Rows = (rows.Text != "") ? int.Parse(rows.Text) : 0;
