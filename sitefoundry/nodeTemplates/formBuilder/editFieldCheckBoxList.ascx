<%@ Control Language="c#" AutoEventWireup="false" Codebehind="editFieldCheckBoxList.ascx.cs" Inherits="Dury.SiteFoundry.nodeTemplates.formBuilder.editFieldCheckBoxList" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<h4>check box list</h4>
